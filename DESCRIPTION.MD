...
The addon hooks into Anki's import process. It specifically looks for cards that Anki categorizes as:
* **Conflicting**
* **Updated**
* **Duplicate**
* **First Field Match**
...
* *Future Plans:* Support for CSV/Text files (comma-separated) might be added in the future, but it is not currently implemented.

### 3. Experimental / "As-Is" Status
This is an **intermediate solution** developed to solve a specific personal use case. While it works well for its intended purpose, it is not a native Anki feature.
...
### 1. 💾 BACKUP YOUR COLLECTION FIRST
...
### 2. 🛡️ RECOMMENDATION: Use Once, Then Disable
...
## 🐞 Issues & Feedback
If the addon does not work as expected, please [**report it on GitHub Issues**](https://github.com/tu_usuario/tu_repo/issues). Since this is a personal project, immediate fixes aren't guaranteed, but reporting bugs helps me.

## Scheenshots

<img src="https://raw.githubusercontent.com/Nechaiter/TU_REPO/main/screenshots/after_import.png" width="500">

---

<img src="https://raw.githubusercontent.com/Nechaiter/TU_REPO/main/screenshots/before_import.png" width="500">
