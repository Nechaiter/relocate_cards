...
// This file only reads and write content in the dialog
(function() {
    
    function insertAddonContainer() {

        if (document.getElementById("addon-options-row")) return;
            ...
            '<div class="' + classes.row + '" id="addon-options-row">' +
                '<div class="' + classes.container + '" style="' + classes.containerStyle + '">' +
                    '<div class="' + classes.positionRelative + '">' +
                        '<h1 class="' + classes.h1 + '">Relocate Options</h1>' +
                    '</div>' +
        ...
        setTimeout(function() {
            let checkbox = document.getElementById('relocate_cards_id');
            if (checkbox) {
    ...
    setTimeout(insertAddonContainer, 500);
    
    
    let observer = new MutationObserver(function(mutations) {
        insertAddonContainer();
    });
